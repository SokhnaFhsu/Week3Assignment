...
GROUP BY customers.customerID, customers.emailAddress, customers.firstName, customers.lastName, addresses.line1, addresses.city, 
addresses.state, addresses.zipCode, customers.phone';// PUT YOUR SQL QUERY HERE
